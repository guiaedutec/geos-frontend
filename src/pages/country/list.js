...
import CountriesTable from "./components/CountryList/CountriesTable";
...
class ListCountries extends React.Component {
  ...
  render() {
    ...
    return (
      <Layout pageHeader={this.translate("CountriesTable.countries")}>
        <Helmet title={this.translate("CountriesTable.countries")} />
