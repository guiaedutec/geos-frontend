...
import AffiliationTable from "./components/AffiliationList/AffiliationTable";
...
class ListCountries extends React.Component {
  ...
  render() {
    ...
    return (
      <Layout pageHeader={this.translate("AffiliationsTable.affiliations")}>
        <Helmet title={this.translate("AffiliationsTable.affiliations")} />
...
export default injectIntl(compose(APIContainer)(ListCountries));
