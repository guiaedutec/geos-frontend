...
// Components
import AdminStateForm from "./components/AdminStateForm";
...
class AdminState extends React.Component {
  constructor() {
    super();
    this.state = {
...
export default injectIntl(compose(AccountsContainer)(AdminState));
