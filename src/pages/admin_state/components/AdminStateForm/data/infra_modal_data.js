export default {
  comp_admins: {
    field: {
      label: "InfraStructureFormModal.computersToAdministrative",
      img: "images/infraestrutura/computador.png",
      img_alt: "InfraStructureFormModal.computersToAdministrative",
    },
    modal: {
      titulo: "InfraStructureFormModal.computersToAdministrative",
      o_que_e: "InfraStructureFormModal.hints.computersToAdministrative.item1",
      quem_usa: "InfraStructureFormModal.hints.computersToAdministrative.item2",
      onde_encontrar:
        "InfraStructureFormModal.hints.computersToAdministrative.item3",
      img: "images/infraestrutura/computador.png",
      img_alt: "InfraStructureFormModal.computersToAdministrative",
    },
  },
  comp_teachers: {
    field: {
      label: "Computadores p/ Professores",
      img: "images/infraestrutura/computador.png",
      img_alt: "Computadores p/ Professores",
    },
    modal: {
      titulo: "Computadores p/ Professores",
      o_que_e:
  ...
  comp_students: {
    field: {
      label: "Dispositivos p/ Alunos",
      img: "images/infraestrutura/dispositivos.png",
      img_alt: "Dispositivos p/ Alunos",
    },
    modal: {
      titulo: "Dispositivos p/ Alunos",
      o_que_e:
        "São dispositivos digitais, podendo ser: computadores, notebook, tablets, celulares da escola etc.",
      quem_usa: "Para uso exclusivo de alunos.",
      onde_encontrar:
        "Normalmente ficam em um espaço específico, como laboratório de informática, em salas de aula ou disponíveis para serem utilizados em sala de aula sendo armazenados em carrinhos ou racks móveis de equipamentos.",
      img: "images/infraestrutura/dispositivos.png",
      img_alt: "Dispositivos p/ Alunos",
    },
  },
  printers: {
    field: {
      label: "Impressoreas/Multifuncional",
      img: "images/infraestrutura/impressora.png",
      img_alt: "Impressoreas/Multifuncional",
    },
    modal: {
      ...
      img: "images/infraestrutura/impressora.png",
      img_alt: "Impressoras/Multifuncional",
    },
  },
  rack: {
    field: {
      label: "Rack de equipamentos",
      img: "images/infraestrutura/rack.png",
      img_alt: "Rack de equipamentos",
    },
    modal: {
  ...
  nobreak: {
    field: {
      label: "Nobreak",
      img: "images/infraestrutura/nobreak.png",
      img_alt: "Nobreak",
    },
    modal: {
      titulo: "Nobreak",
  ...
  switch: {
    field: {
      label: "Switch",
      img: "images/infraestrutura/switch.png",
      img_alt: "Switch",
    },
    modal: {
      titulo: "Switch",
  ...
  firewall: {
    field: {
      label: "Firewall",
      img: "images/infraestrutura/firewall.png",
      img_alt: "Firewall",
    },
    modal: {
      titulo: "Firewall",
  ...
  wifi: {
    field: {
      ...
      img: "images/infraestrutura/wifi.png",
      img_alt: "Wifi/Access Point",
    },
    modal: {
  ...
  projector: {
    field: {
      label: "Projetor Multimídia",
      img: "images/infraestrutura/projetor.png",
      img_alt: "Projetor Multimídia",
    },
    modal: {
  ...
  charger: {
    field: {
      label: "Carrinho Carregador",
      img: "images/infraestrutura/carrinho.png",
      img_alt: "Carrinho Carregador",
    },
    modal: {
      titulo: "Carrinho Carregador",
      o_que_e:
        "É um equipamento, similar a um rack, projetado para o armazenar e recarregar diversos dispositivos simultaneamente (ex. notebooks, tablets etc.) Pode ser de diversos tamanhos para armazenar de 20 a 60 dispositivos.",
      quem_usa: "Professores e/ou administradores da escola.",
      onde_encontrar:
        "Pode ser armazenado em uma sala específica ou laboratório de informática. Também pode ser guardado na sala dos professores ou salas da secretaria escolar.",
      img: "images/infraestrutura/carrinho.png",
      img_alt: "Carrinho Carregador",
    },
  },
  maker: {
    field: {
      ...
      img: "images/infraestrutura/robotica.png",
      img_alt: "Kit de robótica",
    },
    modal: {
